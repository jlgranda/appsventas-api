...
//    public int hashCode() {
//        int hash = 7;
//        hash = 53 * hash + Objects.hashCode(this.invoiceId);
//        hash = 53 * hash + Objects.hashCode(this.facturaElectronicaId);
...
//        hash = 53 * hash + Objects.hashCode(this.cash);
//        hash = 53 * hash + Objects.hashCode(this.change);
//        hash = 53 * hash + Objects.hashCode(this.datePaymentCancel);
